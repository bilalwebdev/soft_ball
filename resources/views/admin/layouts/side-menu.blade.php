<div class="mobile-menu md:hidden">
    <div class="mobile-menu-bar">
        <a href="" class="flex mr-auto">
            <img alt="" class="w-6" src="{{ asset('admin_assets/images/logo.svg') }}">
        </a>
    ...
    <ul class="border-t border-white/[0.08] py-5 hidden">
        ...
        <li>
            <a href="{{ route('admin.all.teams') }}" class="menu">
                <div class="menu__icon"> <i data-lucide="inbox"></i> </div>
                <div class="menu__title"> Teams </div>
            </a>
        </li>
        <li>
            <a href="{{ route('admin.all.tournaments') }}" class="menu">
                <div class="menu__icon"> <i data-lucide="inbox"></i> </div>
                <div class="menu__title"> Tournaments </div>
            </a>
        </li>
        ...
        <li>
            ...
            <ul class="">
                @can('add manager')
                    <li>
                        <a href="{{ route('admin.all.admins') }}" class="menu">
                ...
                @endcan
                <li>
                    <a href="{{ route('admin.all.players') }}" class="menu">
                        <div class="menu__icon"> <i data-lucide="activity"></i> </div>
                        <div class="menu__title"> Players </div>
                    </a>
                </li>
            </ul>
        </li>
...
<div class="flex">
    ...
    <nav class="side-nav">
        <a href="" class="intro-x flex items-center pl-5 pt-4">
            <img alt="" class="w-6" src="{{ asset('admin_assets/images/logo.svg') }}">
            <span class="hidden xl:block text-white text-lg ml-3"> Softball </span>
        </a>
        <div class="side-nav__devider my-6"></div>
        @if (\Auth::user()->type !== 'PLAYER')
            <ul>
                <li>
                    <a href="{{ route('admin.dashboard') }}" class="side-menu @stack('active-dashboard')">
                ...
                <li>
                    <a href="{{ route('admin.all.teams') }}" class="side-menu @stack('active-teams')">
                        <div class="side-menu__icon"> <i data-lucide="inbox"></i> </div>
                        <div class="side-menu__title"> Teams </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.all.tournaments') }}" class="side-menu @stack('active-tournaments')">
                        <div class="side-menu__icon"> <i data-lucide="inbox"></i> </div>
                        <div class="side-menu__title"> Tournaments </div>
                    </a>
                </li>
                @can('add manager')
                    <li>
                        <a href="javascript:;" class="side-menu @stack('active-users') ">
                        ...
                        <ul class="@stack('open-users')">

                            <li>
                                <a href="{{ route('admin.all.admins') }}" class="side-menu @stack('active-admins')">
                ...
                @can('site setting')
                    <li>
                        ...
                        <ul class="">
                            <li>
                                <a href="{{ route('admin.site.slider') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="image"></i> </div>
                                    <div class="side-menu__title"> Home Slider </div>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('admin.site.settings') }}" class="side-menu">
                                    <div class="side-menu__icon"> <i data-lucide="settings"></i> </div>
                                    <div class="side-menu__title"> View Settings</div>
                                </a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <ul class="dropdown-content bg-primary text-white">
                        ...
                        @if (\Auth::user()->type !== 'PLAYER')
                            ...
                            <li>
                                <a href="{{ route('admin.profile.password') }}"
                                    class="dropdown-item hover:bg-white/5"> <i data-lucide="lock"
                        ...
                        <li>
                            {{-- <a href="{{ route('logout') }}" class="dropdown-item hover:bg-white/5"> <i data-lucide="toggle-right"
                                    class="w-4 h-4 mr-2"></i> Logout </a> --}}<form method="POST" action="{{ route('logout') }}">
                                @csrf

                                <button type="submit" class="dropdown-item hover:bg-white/5">
                                    <i data-lucide="toggle-left" class="w-4 h-4 mr-2"></i> Logout
                                </button>
                            </form>
                        </li>
                    </ul>
                                ...
                                <tbody>
                                        ...
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-9.jpg" title="Uploaded at 30 March 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-12.jpg" title="Uploaded at 13 October 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-8.jpg" title="Uploaded at 25 October 2022">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-1.jpg" title="Uploaded at 29 September 2020">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-12.jpg" title="Uploaded at 18 May 2020">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-12.jpg" title="Uploaded at 7 June 2022">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 7 October 2020">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-8.jpg" title="Uploaded at 14 October 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-7.jpg" title="Uploaded at 6 July 2020">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                    ...
                                    <tr class="intro-x">
                                        <td class="w-40">
                                            <div class="flex">
                                                <div class="w-10 h-10 image-fit zoom-in">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-3.jpg" title="Uploaded at 18 June 2021">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-13.jpg" title="Uploaded at 4 February 2022">
                                                </div>
                                                <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                    <img alt="Midone - HTML Admin Template" class="tooltip rounded-full" src="dist/images/preview-8.jpg" title="Uploaded at 23 February 2022">
                                                </div>
                                            </div>
                                        </td>
                                        <td>
